    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0c0c10] p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-50 w-100 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 text-3xl shadow-lg">
            <img src="/logo.png" alt="Logo" className="h-50 w-90  rounded-xl" />
          </div>
